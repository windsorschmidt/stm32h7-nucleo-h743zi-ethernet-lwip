##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.0.0] date: [Tue Mar 05 12:24:41 PST 2019] 
##########################################################################################################################
...
flash-openocd: $(BUILD_DIR)/$(TARGET).elf
	openocd -f /usr/share/openocd/scripts/board/st_nucleo_h743zi.cfg -c init -c targets -c 'reset halt' -c 'flash write_image erase build/H743ZI_LwIP.elf' -c 'reset halt' -c 'reset run' -c shutdown
